...
import {getAllRestaurantsLocation} from "../api/mapAPI";
...
export const getRestaurantsLocationList = createAsyncThunk("category/getRestaurantsLocationList", async (category, thunkAPI) => {
  const data = await getAllRestaurantsLocation(category);
  return data;
});
...
const categorySlice = createSlice({
  ...
  reducers: {
    ...
    sortRestaurantsLocationList: (state) => {
      // 정렬 액션 추가
